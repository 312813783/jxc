...
public class GoodsServiceImpl implements GoodsService {
		...
		Page<Goods> pageUser=goodsRepository.findAll(new Specification<Goods>() {
			...
			public Predicate toPredicate(Root<Goods> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
				...
				if(goods!=null){
					...
					if(StringUtil.isNotEmpty(goods.getCode())){
						predicate.getExpressions().add(cb.like(root.get("code"), "%"+goods.getCode().trim()+"%"));
					}
	...
	@Override
	public Map<String, Object> modifyDiscount(Integer id, Integer discount) {
