...
public class CustomerReturnListAdminController {
	...
	public Map<String,Object> save(CustomerReturnList customerReturnList,String goodsJson)throws Exception{
		...
		logService.save(new Log(Log.ADD_ACTION,"Add customer return")); 
	...
	public Map<String,Object> delete(Integer id)throws Exception{
		...
		logService.save(new Log(Log.DELETE_ACTION,"Delete customer return information"+customerReturnListService.findById(id)));  // 写入日志
		resultMap.put("success", true);		
		return resultMap;
	}
}
