...
public class GoodsTypeAdminController {
	...
	public String loadTreeInfo()throws Exception{
    	logService.save(new Log(Log.SEARCH_ACTION,"Query drug category information")); // 写入日志
	...
	public Map<String,Object> save(String name,Integer parentId)throws Exception{
		...
		logService.save(new Log(Log.ADD_ACTION,"Add drug category information"+goodsType)); 
	...
	public Map<String,Object> delete(Integer id)throws Exception{
		...
		logService.save(new Log(Log.DELETE_ACTION,"Delete drug category information"+goodsType));  // 写入日志
