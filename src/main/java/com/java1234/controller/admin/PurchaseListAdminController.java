...
public class PurchaseListAdminController {
	...
	public Map<String,Object> save(PurchaseList purchaseList,String goodsJson)throws Exception{
		...
		logService.save(new Log(Log.ADD_ACTION,"Add purchase order")); 
	...
	public Map<String,Object> delete(Integer id)throws Exception{
		...
		logService.save(new Log(Log.DELETE_ACTION,"Delete purchase order information"+purchaseListService.findById(id)));  // 写入日志
		resultMap.put("success", true);		
		return resultMap;
	}
