...
public class ReturnListAdminController {
	...
	/**
	 * <br>添加退货单 以及所有退货单商品 以及 修改商品的成本均价
	 * @param returnList
	 * @param goodsJson
	 * @return
	 * @throws Exception
	...
	public Map<String,Object> save(ReturnList returnList,String goodsJson)throws Exception{
		...
		logService.save(new Log(Log.ADD_ACTION,"Add return order")); 
	...
	public Map<String,Object> delete(Integer id)throws Exception{
		...
		logService.save(new Log(Log.DELETE_ACTION,"Delete return order information"+returnListService.findById(id)));  // 写入日志
		resultMap.put("success", true);		
		return resultMap;
	}
}
